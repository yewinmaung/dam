            ...
            <main class="col-10 bg-secondary">
                ...
                <div class="container-fluid mt-3 p-4">
                    <div class="row flex-column flex-lg-row">
                        <div class="">
                            <form action="destrictcreate" method="post" class="w-100 d-flex justify-content-center align-items-center">

                                <div class="card w-50 p-2">
                                    <div class="row mb-3">

                                        <div class="col-sm-10 w-100">
                                            <input type="text" required name="name" placeholder="Destrict name" class="form-control" id="inputEmail3">
                                        </div>
                                    </div>
