                ...
                <div class="container-fluid mt-3 p-4">
                    <div class="row flex-column flex-lg-row">
                        <div class="">
                            ...
                            <form action="uploadPost" method="post" enctype="multipart/form-data" class="w-100 d-flex justify-content-center align-items-center">

                                <div class="card w-50 p-2">

                                    <div class="form-floating mb-3">
                                        <input type="text" name="title" placeholder="Post Title" class="form-control" id="inputEmail3">
